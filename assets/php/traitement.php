<?php
//Les fonctions du jeu, c'est juste la trame donc ça ne fonctionne évidemment pas, c'est pour pouvoir suivre
...
function traitement() {
    ...
    if ($mot.length==8) { //Test de la taille du mot entré
        ...
        for ($i=0; $i<8;$i++) {
            //mettre le fond de chaque case avec l'image bleue, background_irl
